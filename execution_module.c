 ...
 * @info: Pointer to shell_info struct.
 *
 * Description: Checks for and executes built-in commands like:
 * exit, env, unsetenv,
...
/**
 * executeCurrentCommand - Execute the current command
 * in the shell_info struct.
 *
 * @info: Pointer to shell_info struct.
 *
 * Description: Executes the command in the 'currentCmd' field
