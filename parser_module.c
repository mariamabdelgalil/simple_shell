...
/**
 * parseCommandInput - Parse command input and store it in the shell_info struct.
 ...
 * stores the parsed arguments in the 'currentCmd' field of the shell_info struct.
...
/**
 * parseInput - Parse the input line and store commands in the shell_info struct.
 * @info: Pointer to shell_info struct.
 *
 * Description: Removes comments, adjusts command chain, initializes commands,
 * and parses the input line to store commands in the 'cmds' field of the shell_info struct.
 *
 * Return: void
 */
